            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form role="form" class="user" action="<?php echo site_url('adminpage/login') ?>" method="POST">
                    <h3 style="color:red;text-align: center"><?php echo form_error('login') ?></h3>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="adname" placeholder="Nhập tài khoản quản trị viên">
                      <div id="username_error" class="error"><?php echo form_error('adname') ?></div>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="password" placeholder="Nhập mật khẩu">
                      <div id="pass_error" class="error"><?php echo form_error('password') ?></div>
                    </div>
<!--                     <div class="form-group">
