<?php require('ad_header_view.php') ?>
      ...
      <div class="col-md-6">
        ...
        <form action="  <?php echo base_url() ?>adminpage/Ad_wine/updatecategory" method="POST" >
          ...
          <?php foreach ($category as $value): ?>
            ...
            <input type="hidden" class="form-control" id="name" name="id" value="<?php echo $value['cid'] ?>">
            <input type="text" class="form-control" id="name" name="name" value="<?php echo $value['cname'] ?>">
            </div>
