<?php require('ad_header_view.php') ?>
      ...
      <div class="col-md-6">
        ...
        <form action="  <?php echo base_url() ?>adminpage/Ad_slideshow/updateslideshow" method="POST" >
          ...
          <?php foreach ($slideshow as $value): ?>
            ...
            <br>
            <label for="pwd">Tên slide</label>
            <input type="hidden" class="form-control" id="name" name="id" value="<?php echo $value['imgslideid'] ?>">
            <input type="text" class="form-control" id="name" name="name" value="<?php echo $value['imgslide'] ?>">
            </div>
